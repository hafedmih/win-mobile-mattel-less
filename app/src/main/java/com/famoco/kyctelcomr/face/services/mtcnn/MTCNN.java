package com.famoco.kyctelcomr.face.services.mtcnn;
...
public class MTCNN {
    ...
    public void load() throws IOException {
        ...
        pInterpreter = new Interpreter(MyUtil.loadModelFile(context.getAssets(), MODEL_FILE_PNET), options);
        rInterpreter = new Interpreter(MyUtil.loadModelFile(context.getAssets(), MODEL_FILE_RNET), options);
        oInterpreter = new Interpreter(MyUtil.loadModelFile(context.getAssets(), MODEL_FILE_ONET), options);
    }
    ...
    public Vector<Box> detectFaces(Bitmap bitmap, int minFaceSize) {
        if (bitmap == null) return new Vector<>();
        Vector<Box> boxes;
        try {
